...
export default {
  ...
  props: {
    ...
    imgs: {
      type: Array,
      default: ['/static/uploads/pic1.jpg',
                '/static/uploads/pic2.jpg',
                '/static/uploads/pic3.jpg',
                '/static/uploads/pic4.jpg',
                '/static/uploads/pic5.jpg',
                '/static/uploads/pic6.jpg',
                '/static/uploads/pic7.jpg',
                '/static/uploads/pic8.jpg',
                '/static/uploads/pic9.jpg',
                '/static/uploads/pic10.jpg'
      ]
    }
  },
  data() {
  ...
  methods: {
    ...
    getRandomImg() {
      ...
      // console.log(num)
      return `/static/uploads/pic${num}.jpg`
...
.slide-verify-refresh-icon {
  ...
  height: 34px;
  cursor: pointer;
  background: url("../../assets/codeimg/icon_light.png") 0 -437px;
...
.slide-verify-slider-mask-item-icon {
  ...
  width: 14px;
  height: 12px;
  background: url("../../assets/codeimg/icon_light.png") 0 -26px;
  background-size: 34px 471px;
}
